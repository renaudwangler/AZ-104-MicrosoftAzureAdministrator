...
In this task, we will move the disk resource you created in the previous task to another resource group. 

1. Search for and select **Resource groups**. 

1. On the **Resource groups** blade, click the entry representing the **StagiaireXXX-RG1** resource group.
...
1. On the **Move resources** blade, select **StagiaireXXX-RG2**, select the checkbox **I understand that tools and scripts associated with moved resources will not work until I update them to use new resource IDs**, and click **OK**.
...
1. In the list of resource groups, click the entry representing the **StagiaireXXX-RG1** resource group.

1. On the **StagiaireXXX-RG1** resource group blade, click **Locks** and add a lock with the following settings:
...
1. On the **tagiaireXXX-RG1** resource group blade, click **Overview**, in the list of resource group resources, select the entry representing the disk you created earlier in this task, and click **Delete** in the toolbar. 
...
1. Navigate back to the list of resources of the **StagiaireXXX-RG1** resource group and click the entry representing the **az104-03a-disk2** resource. 

1. On the **az104-03a-disk2** blade, in the **Settings** section, click **Configuration**, set the disk type to **Premium SSD**, and save the change. Verify that the change was successful.
...
1. Navigate to the **StagiaireXXX-RG1** resource group blade, display its **Locks** blade, and remove the lock **az104-03a-delete-lock** by clicking the **Delete** link on the right-hand side of the **Delete** lock entry.
